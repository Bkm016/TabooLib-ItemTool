 ...
 */
public abstract class ItemToolPlugin extends JavaPlugin {
    ...
    protected static ItemToolPlugin plugin;
    ...
    protected static boolean forge = Loader.forName("net.minecraftforge.classloading.FMLForgePlugin", false, ItemToolPlugin.class.getClassLoader()) != null;
...
//    }
    ...
    private static Class<?> getMainClass() {
        ...
        try {
            ZipFile zipFile = new ZipFile(toFile(ItemToolPlugin.class.getProtectionDomain().getCodeSource().getLocation().openStream(), file));
    ...
    private static void init() {
        ...
        if (!libFile.exists()) {
            // 本地资源检测
            InputStream resourceAsStream = ItemToolPlugin.class.getClassLoader().getResourceAsStream("TabooLib.jar");
    ...
    public static ItemToolPlugin getPlugin() {
        return plugin;
    }
